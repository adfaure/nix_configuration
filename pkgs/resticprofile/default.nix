# FIXME: Took from here: https://github.com/bbigras/nixpkgs/blob/c8de574401acba0803a4331a9f7f432bb021263b/pkgs/by-name/re/resticprofile/package.nix
# This should be removed when the upstream fix has been integrated
{
  lib,
  buildGoModule,
  fetchFromGitHub,
